...
class TestDecorators(unittest.TestCase):
    def test_cannot_reassign_constant_class_attribute(self):
        ...
        self.assertEqual('You cannot set the constant MY_CONST1 in class Example1', str(context.exception))
    ...
    def test_can_reassign_class_attribute(self):
        ...
        Example1.class_attr1 = 'new value'
        Example1.class_attr2 = 'another new value'

        self.assertEqual('new value', Example1.class_attr1)
        self.assertEqual('another new value', Example1.class_attr2)
    ...
    def test_can_reassign_instance_attribute(self):
        ...
        example = Example1(attr1='value for instance attribute 1')
